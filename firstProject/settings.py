...
TEMPLATES = [
    {
        ...
        'DIRS': [BASE_DIR / "templates"],  # You can create a global templates folder
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
                ...
                'django.contrib.messages.context_processors.messages',  # ✅ fixed
            ],
        },
    },
]
...
STATICFILES_DIRS = [os.path.join(BASE_DIR, 'static')]  # ✅ Make sure 'static/' folder exists
